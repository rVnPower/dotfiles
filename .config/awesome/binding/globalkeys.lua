...
function _M.get()
  local globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("bash ~/.config/rofi/scripts/rofi-main.sh") end,
              {description = "run rofi", group = "launcher"}),
    -- Custom
    awful.key({ }, "Print", function() awful.spawn.with_shell("bash ~/.config/rofi/scripts/rofi-exts.sh screenshot") end,
              {description = "show screenshot selection", group = "launcher"}),
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("bash ~/.config/rofi/scripts/rofi-exts.sh session") end,
