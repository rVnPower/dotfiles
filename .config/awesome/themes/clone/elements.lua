...
theme.titlebar_bg_normal = gmc.color['grey800']   .. "cc"
theme.titlebar_bg_focus  = gmc.color['black']   .. "cc"
theme.titlebar_fg_focus  = gmc.color['white']   .. "cc"
theme.titlebar_fg_normal  = gmc.color['black']   .. "cc"
